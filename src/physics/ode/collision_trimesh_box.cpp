...
void __cdecl cldClipping(collData_t *tbData, const dVector3 *v0, const dVector3 *v1, const dVector3 *v2)
{
    ...
    double v8; // st7
    const char *v9; // eax
    [[maybe_unused]] const char *v10; // eax
    ...
    [[maybe_unused]] float *normal; // [esp+D0h] [ebp-4BCh]
    ...
    int Stride)
{
    ...
    [[maybe_unused]] const float (*mRotBox)[12]; // [esp+110h] [ebp-Ch]
    const unsigned __int16 *pIndices; // [esp+114h] [ebp-8h]
    [[maybe_unused]] const float (*vPosBox)[4]; // [esp+118h] [ebp-4h]
...
// Legacy upstream trimesh collider state. The implementation below is
// intentionally disabled in favour of CoD4's typed collider above.
#if 0
// box data
