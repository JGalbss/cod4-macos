...
{
    [[maybe_unused]] float *maxs; // [esp+18h] [ebp-33Ch]
    [[maybe_unused]] float *mins; // [esp+1Ch] [ebp-338h]
    [[maybe_unused]] int v8; // [esp+40h] [ebp-314h]
    [[maybe_unused]] int v9; // [esp+40h] [ebp-314h]
    [[maybe_unused]] int v10; // [esp+40h] [ebp-314h]
    [[maybe_unused]] int v11; // [esp+40h] [ebp-314h]
    [[maybe_unused]] int v12; // [esp+40h] [ebp-314h]
    [[maybe_unused]] int v13; // [esp+40h] [ebp-314h]
    [[maybe_unused]] int v14; // [esp+40h] [ebp-314h]
    [[maybe_unused]] int v15; // [esp+40h] [ebp-314h]
    [[maybe_unused]] int v16; // [esp+40h] [ebp-314h]
    [[maybe_unused]] float v17; // [esp+44h] [ebp-310h]
    [[maybe_unused]] float v18; // [esp+44h] [ebp-310h]
    [[maybe_unused]] float v19; // [esp+44h] [ebp-310h]
    [[maybe_unused]] float v20; // [esp+44h] [ebp-310h]
    [[maybe_unused]] float v21; // [esp+44h] [ebp-310h]
    [[maybe_unused]] float v22; // [esp+44h] [ebp-310h]
    [[maybe_unused]] float v23; // [esp+44h] [ebp-310h]
    [[maybe_unused]] float v24; // [esp+44h] [ebp-310h]
    [[maybe_unused]] float v25; // [esp+44h] [ebp-310h]
    [[maybe_unused]] float v26; // [esp+48h] [ebp-30Ch]
    [[maybe_unused]] float v27; // [esp+48h] [ebp-30Ch]
    [[maybe_unused]] float v28; // [esp+48h] [ebp-30Ch]
    [[maybe_unused]] float v29; // [esp+48h] [ebp-30Ch]
    [[maybe_unused]] float v30; // [esp+48h] [ebp-30Ch]
    [[maybe_unused]] float v31; // [esp+48h] [ebp-30Ch]
    [[maybe_unused]] float v32; // [esp+48h] [ebp-30Ch]
    [[maybe_unused]] float v33; // [esp+48h] [ebp-30Ch]
    [[maybe_unused]] float v34; // [esp+48h] [ebp-30Ch]
    [[maybe_unused]] XBoneInfo *v35; // [esp+4Ch] [ebp-308h]
    [[maybe_unused]] float boneInfo; // [esp+58h] [ebp-2FCh]
    [[maybe_unused]] float v37; // [esp+5Ch] [ebp-2F8h]
    [[maybe_unused]] float v38; // [esp+60h] [ebp-2F4h]
    DObjSkelMat boneAxis; // [esp+64h] [ebp-2F0h] BYREF
    [[maybe_unused]] float zw; // [esp+A4h] [ebp-2B0h]
    [[maybe_unused]] float zz; // [esp+A8h] [ebp-2ACh]
    [[maybe_unused]] float yw; // [esp+ACh] [ebp-2A8h]
    [[maybe_unused]] float yz; // [esp+B0h] [ebp-2A4h]
    [[maybe_unused]] float yy; // [esp+B4h] [ebp-2A0h]
    [[maybe_unused]] float xw; // [esp+B8h] [ebp-29Ch]
    [[maybe_unused]] float xz; // [esp+BCh] [ebp-298h]
    [[maybe_unused]] float xy; // [esp+C0h] [ebp-294h]
    [[maybe_unused]] float xx; // [esp+C4h] [ebp-290h]
    float v49[3]; // [esp+C8h] [ebp-28Ch] BYREF
    [[maybe_unused]] float transWeight; // [esp+D4h] [ebp-280h]
    [[maybe_unused]] float v51; // [esp+D8h] [ebp-27Ch]
    [[maybe_unused]] float v52; // [esp+DCh] [ebp-278h]
    [[maybe_unused]] float v53; // [esp+E0h] [ebp-274h]
    [[maybe_unused]] float v54; // [esp+E4h] [ebp-270h]
    [[maybe_unused]] DObjAnimMat *mat; // [esp+E8h] [ebp-26Ch]
    [[maybe_unused]] int boneIndex; // [esp+ECh] [ebp-268h]
    [[maybe_unused]] unsigned int animPartBit; // [esp+F0h] [ebp-264h]
    [[maybe_unused]] int boneCount; // [esp+F4h] [ebp-260h]
    XBoneInfo *boneInfoArray[128]; // [esp+F8h] [ebp-25Ch] BYREF
    [[maybe_unused]] float4 minWorld; // [esp+300h] [ebp-54h]
    float4 maxWorld; // [esp+310h] [ebp-44h] BYREF
    [[maybe_unused]] DObjAnimMat *boneMatrix; // [esp+320h] [ebp-34h]
    [[maybe_unused]] int surfCount; // [esp+324h] [ebp-30h]
    int partBits[4]; // [esp+328h] [ebp-2Ch] BYREF
    [[maybe_unused]] const DObj_s *obj; // [esp+338h] [ebp-1Ch]
    [[maybe_unused]] GfxSceneEntity *localSceneEnt; // [esp+33Ch] [ebp-18h]
    [[maybe_unused]] unsigned int state; // [esp+340h] [ebp-14h]

    if (InterlockedCompareExchange((volatile LONG *)&sceneEnt->cull, static_cast<LONG>(1), static_cast<LONG>(0)))
    {
        *pLocalSceneEnt = 0;
        if (waitForCullState)
        {
    ...
    else
    {
        ...
        *pObj = obj;
        ...
        if (useFastFile->current.enabled || !DObjBad(obj))
        {
            ...
            boneMatrix = surfCount ? R_DObjCalcPose(localSceneEnt, obj, partBits) : nullptr;
            if (surfCount && boneMatrix != 0)
            {
            ...
            {
                static int poseFailureReports = 0;
                if (poseFailureReports++ < 8)
                {
                    Com_Printf(8,
                        "[model-pose] no draw: obj=%p surfCount=%d boneMatrix=%p lod0=%d "
                        "partBits=%08x/%08x/%08x/%08x\n",
                        obj, surfCount, boneMatrix, localSceneEnt->cull.lods[0],
                        partBits[0], partBits[1], partBits[2], partBits[3]);
                }
...
void __cdecl R_UpdateGfxEntityBoundsCmd(GfxSceneEntity **data)
{
    ...
    [[maybe_unused]] GfxSceneEntity *sceneEnt; // [esp+8h] [ebp-8h]
    [[maybe_unused]] GfxSceneEntity **pSceneEnt; // [esp+Ch] [ebp-4h]
