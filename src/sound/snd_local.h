...
#endif
// POSIX/Switch: Miles is unavailable; audio uses OpenAL-soft layer (TBD).
#include "snd_public.h"

[[maybe_unused]] static const char *snd_outputConfigurationStrings[6] = { "Windows default", "Mono", "Stereo", "4 speakers", "5.1 speakers", NULL }; // idb
